...
class assetAPICommand extends Command {
  constructor() {
    super('asset', {
      ...
      description : {
        content :
            'Make a call to the Roblox Asset Api and return the response.',
  ...
  async exec(message, args) {
    let url = `https://api.roblox.com/ownership/hasasset?assetId=${
        args.assetID}&userId=${args.userID}` // Get url from command arguments.
